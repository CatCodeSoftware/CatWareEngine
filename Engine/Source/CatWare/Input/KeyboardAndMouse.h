...
namespace CatWare
{
	namespace Input
	{
        ...
        /* I copied all of these from SDL's SDL_scancode.h file
         Some of these are android buttons - PT */
		enum KeyCode
		{
            KEY_UNKNOWN = 0,
		...
		CATWARE_API void SetKeyPressed( int keyCode, bool isPressed );
        CATWARE_API void SetMousePressed( int buttonCode, bool isPressed );

        CATWARE_API bool IsKeyPressed( int keyCode );
        CATWARE_API bool IsMousePressed( int buttonCode );

        CATWARE_API void SetMouseMotion( Vector2D motion );
        CATWARE_API Vector2D GetMouseMotion( );
	}
}